import React, { useState, Dispatch, SetStateAction, ChangeEvent, useEffect, useRef } from 'react';
import Link from 'next/link';
import Image from 'next/image';
import usePreventScroll from '@hooks/use-prevent-scroll';
import useDebounce from '@hooks/use-debounce';
import { PreviewItemType } from '@components/recommended-list';
  ...
  return (
    <Overlay $isOpen={isOpen}>
      <Container ref={searchRef}>
        ...
        />
        <ResultItems $isMessageDisplayed={isMessageDisplayed} $isOpen={!!debouncedSearch}>
          {isMessageDisplayed && (
            <>
